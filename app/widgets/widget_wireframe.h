...
#ifndef WIDGET_WIREFRAME_H
#define WIDGET_WIREFRAME_H
...
GFX_DEFINE_APPLIER(WireframeDemo, Color)
GFX_DEFINE_APPLIER(WireframeDemo, BgColor)
GFX_DEFINE_APPLIER(WireframeDemo, bg)
